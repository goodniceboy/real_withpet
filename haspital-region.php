      ...
      <section id="home" class="slider_section">
         <div class="container">
            ...
            <div class="welcome-hero-serch-box">
              <form action="haspitalname-search.php" method="get" class="welcome-hero-form">
                ...
                <ul>
                    <li>
                        <div class="single-list-topics-content">
                          <a href="seoul-haspital-search.php">                          
                    ...
                    <li>
                      <div class="single-list-topics-content">
                        <a href="incheon-haspital-search.php">
                    ...
                    <li>
                        <div class="single-list-topics-content">
                          <a href="gyunggi-haspital-search.php">                          
                    ...
                    <li>
                        <div class="single-list-topics-content"> 
                          <a href="gangwon-haspital-search.php">                          
                    ...
                    <li>
                      <div class="single-list-topics-content">
                        <a href="daejeon-haspital-search.php">         
                    ...
                    <li>
                        <div class="single-list-topics-content">
                          <a href="chungcheong-haspital-search.php">         
                    ...
                    <li>
                      <div class="single-list-topics-content">
                        <a href="busan-haspital-search.php">                           
                    ...
                    <li>
                      <div class="single-list-topics-content">
                        <a href="daegu-haspital-search.php">                         
                    ...
                    <li>
                        <div class="single-list-topics-content">
                          <a href="gyungsang-haspital-search.php">                         
                    ...
                    <li>
                      <div class="single-list-topics-content"> 
                        <a href="gwangju-haspital-search.php">                          
                    ...
                    <li>
                        <div class="single-list-topics-content"> 
                          <a href="jeonra-haspital-search.php">                          
                    ...
                    <li>
                        <div class="single-list-topics-content">    
                          <a href="jeju-haspital-search.php">                       
